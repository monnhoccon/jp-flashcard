...
import 'package:jp_flashcard/screens/quiz_page/quizes/kanji_short_answer_quiz.dart';
import 'package:jp_flashcard/screens/quiz_page/components/quiz_answer_dialog.dart';
import 'package:jp_flashcard/screens/quiz_page/quizes/word_selection_quiz.dart';
import 'package:jp_flashcard/screens/quiz_page/quizes/word_short_answer_quiz.dart';
...
class QuizManager extends ChangeNotifier {
  ...
  void _initVariables() async {
    ...
    _flashcardList = FlashcardManager(repoId: repoId);
